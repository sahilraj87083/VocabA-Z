...
Home_win.pack()
img =Image.open("E:\Bennett\Projects\I year I sem project/vocabA-z.png")
...
img_2 =Image.open("E:\Bennett\Projects\I year I sem project/rem2.jpg")                           #changes
...
def notifyme():
    ...
    while not(i):
            ...
            if len(Ynoti)>0:
                ...
                duration=5,icon_path="D:\BUProject/icon.ico.ico",callback_on_click=dispdata)
                if totaltime==0:
